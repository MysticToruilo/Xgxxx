exports.noAbsen = () =>{
return `Lagi Ga Ada Absen Dek`
}
exports.StartAbsen = () =>{
	return`Mulai Absen`
	}
exports.DahAbsen = () =>{
	return`Luwh Udah Bilek Amat`
	}
exports.DelAbsen = () =>{
	return`Dah Ga Ada Absen Barusan Di Hapus Atmin`
	}
exports.adaAbsen = () =>{
	return`Belum Selesai Absen Di Grup Ini,mending hapus absen sebelumnya dulu`
	}
exports.SAbsen = () =>{
...
exports.OkOn = (command) => {
    return `${command} Dah Aktif Aktif`
}
...
exports.NoMsgBot = () => {
    return `Sinting apa? Bot Ga Bisa Hapus Pesan Untuk Semua Orang Punya Orang Lain!`
}
exports.ToimgErr = () => {
...
exports.MauKick = () => {
    return `Masukkin Nomor/Tek/Reply Pesannya,Nanti Gw Kick`
}
exports.MauAdd = () => {
...
exports.AnonOn = () => {
    return ` Kamu masih dalam sesi chat dengan partner!`
}
...
/////////
exports.private = () =>{
	return`Ini Fitur Private Masih Waras Ga Lu?`
	}
exports.wait = () => {
    return `Bentar y lagi di proses`
}
exports.ok = () => {
    return `Nih dah selesai,bilang apa lu?`
}

exports.err = () => {
    return `Fitur Eror Kemungkinan Karena Apikey Habis jangan spam y`
}
exports.erorLink = () => {
    return `Lu Kasih Link Apaan? Commandnya buat apa,coba cek ulang-_`
}
exports.media = () => {
    return `Pilih Dek,jangan pura pura gatau deh `
}
...
exports.emptyMess = () => {
    return `Yah Minimal P lah ini kosonh ngotak dong`
}
...
exports.groupOnly = () => {
    return `Cuma Di Grup ga bisa di pc`
}

exports.adminOnly = () => {
    return `Minimal Atmin yh dek`
}
...
exports.notAdmin = () => {
    return `Dia Ke Detect Bukan Atmin`
}

exports.adminAlready = () => {
    return `Dia Udah Atmin Jangan spam spam gw sibuk`
}

exports.botNotAdmin = () => {
    return `Minimal Tuh Bot Atmin`
}
...
exports.videoLimit = () => {
    return `Video Lu besar amat kek dosa`
}
...
4. Kami Ga Menerima Grup Dari Luar Negri

Terimakasih! 
`
}
exports.welcome = () =>{
	return`Intro Dulu Lah Dek
