...
// Free apikey
global.APIKeys = {
	'https://api.zeeoneofc.xyz': '62wZHJpN',  // login https://api.zeeoneofc.xyz to get apikey || https://api-alphabot.herokuapp.com
}
...
global.ownername= "xɢᴛɪʙxᴄʏʙ" //nama kalian
...
global.mess = {
    sukses: 'Udah Nih',
    admin: 'Enak Aja Bukan Atmin Luwh Deck',
    botAdmin: 'Yah Minimal Gw Atmin Dong',
    owner: 'Luwh Bukan Owner',
    group: 'Fitur Grup Dipake Di Pc Lol Dek',
    private: 'Fitur Private Dipake Di Grup Lol Dek',
	bot: 'jadi bot dulu lah dek',
    errtoimg: 'Maaf Saat Ini Belum Support Sticker Gif !',
    wait: 'Tunggu Dek😅☝🏻',
	lockCmd: 'Males Aktifin Nanti Aja Tunggu Owner Mau',
